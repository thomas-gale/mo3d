...
fn test_construct_bvh() raises:
    ...
    assert_equal(root_binary_children.left, 4)
    assert_equal(root_binary_children.right, 5)
    ...
    assert_equal(left_binary_children.right, 0)
    ...
    assert_equal(right_binary_children.left, 1)
    assert_equal(right_binary_children.right, 2)
